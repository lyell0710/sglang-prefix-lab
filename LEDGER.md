...
> 过程日记:[LAB_JOURNAL.md](LAB_JOURNAL.md) · 简历映射:[RESUME_EVIDENCE.md](RESUME_EVIDENCE.md) ·
> 预注册协议:[docs/PLAN.md](docs/PLAN.md) / [docs/PLAN_router_matrix.md](docs/PLAN_router_matrix.md)
...
- 双副本 router 性能矩阵(S02-S07,预注册协议=[docs/PLAN_router_matrix.md](docs/PLAN_router_matrix.md) +
  [config/protocol-router-v1.json](config/protocol-router-v1.json))——serving 部署故事的下一阶段,**需整机独占,择机执行**。
